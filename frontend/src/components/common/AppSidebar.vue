...
const mainNav = [
  ...
  { to: '/candidatures', label: 'Candidatures', icon: 'candidature' },
]
  ...
  >
    ...
    <div class="flex items-center justify-between px-5 py-5">
      <div class="flex items-center gap-3">
        ...
        <span class="text-lg font-bold tracking-wide">ESG Mefali</span>
      </div>
      <!-- Mobile close -->
      <button
    ...
    <nav class="mt-2 flex-1 space-y-1 overflow-y-auto px-3">
      ...
      >
        ...
        <!-- Candidature (document-check) icon -->
        <svg v-else-if="item.icon === 'candidature'" class="h-5 w-5 shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
          <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" />
          <polyline points="14 2 14 8 20 8" />
